      ...
      <aside className="flex w-56 flex-col border-r border-slate-800 bg-slate-900/80">
            ...
            links.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={`flex items-center gap-2 rounded-lg px-3 py-2 text-sm ${
                    isActive ? "bg-violet-600/90 text-white" : "text-slate-400 hover:bg-slate-800 hover:text-slate-200"
                  }`}
                >
        ...
        <div className="border-t border-slate-800 p-3">
          ...
          <button
            ...
            className="mt-2 w-full rounded-lg border border-slate-700 px-2 py-1.5 text-xs text-slate-400 hover:bg-slate-800 hover:text-slate-200"
          >
            Sign out
          </button>
        </div>
